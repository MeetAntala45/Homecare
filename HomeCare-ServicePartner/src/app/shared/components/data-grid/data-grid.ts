...
export class DataGrid {
  ...
  ngAfterViewChecked(): void {
    if (this.highlightRowKey && !this.scrolledToHighlight) {
      const row = this.el.nativeElement.querySelector('.highlight-row');
      if (row) {
  ...
  setStatus(status: 'pending' | 'completed') {
